		 ...
		 <!-- creating image upload and crop for the my profile picture -->
            ...
            <form id="uploadimage" action="" method="post" enctype="multipart/form-data">   
				<div class="thumbnail" style="border: 0">
					<div class="caption">
						<h4></h4>
						<span id="upload_user_image" style="cursor: pointer;"><i class="fa fa-upload fa-fw w3-margin-right" style="color: white; margin-top: 12%;"></i>Upload your image</span>
					...
					<p class="w3-center"><img id="user_profile_image" src="images/avatar3.png" class="w3-circle" style="height:50%;width:50%" alt="Avatar"></p>
				</div>
			</form>
...
function RemoveItemFromUserCart($cart_item_count, $the_item_id, $the_item_desc, $total_items_val, $the_item_image, $each_items_val)
{
	...
	else if (rcount > 0)
	{
		...
		/*if(rcount == 0)
		{
			$('#cart_items_count').html(ccount);
			$('#cart_items_count_mob').html(ccount);
		}
		else
		{
			var ccounts = parseInt(ccount.trim()) - 1;
