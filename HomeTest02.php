...
function ShowUserCart($noofitems)
{
	...
	if($noofitems > 0)
	{
		$("#usercartdiv").html(htmlStr);
	}
	else
	{
		$("#usercartdiv").html(htmlStrNone);
	}
	
	//<a href="#"><span class="glyphicon glyphicon-shopping-cart"></span> Cart
		//<span class="navbar-right" id="itemCount">0</span></a>
}
</script>
</head>
<body>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog" style="width: 95%;">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><img src="images/cart.png"style="width: 5%;"></h4>
        </div>
  ...
  <div class="modal fade" id="myModalNone" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Your Shopping Cart is empty...Continue Shopping</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
